                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="/" className="flex ms-2 md:me-24">
                            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Invoice App</span>
                        </a>
                    </div>
                    <div className="flex items-center">
                        <div className="flex items-center ms-3 gap-4">
                            ...
                            <button className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                                ...
                                <HiUserCircle className="w-8 h-8 text-gray-400 bg-white rounded-full" />
                            </button>
                        </div>
                    </div>
                </div>
